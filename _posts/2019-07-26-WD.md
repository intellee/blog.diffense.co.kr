...
지난 [DIFF-2019-004](http://blog.diffense.co.kr/2019/07/22/WD/)에서 "패치가드를 우회할 수 있는 커널후킹 라이브러리 InfinityHook"에 대한 내용을 얘기했었습니다. 이번 내용은 *InfinityHook*을 빌드 및 실행하는 방법과 이것을 활용하는 방법에 대해 알아보고자 합니다.
