...
![hardlink write](https://github.com/yong1212/blog.diffense.co.kr/raw/master/img/hardlink_write.png)  
...
```
James Forshaw가 만든 CreateNativeHardlink를 이용해 하드링크(UpdateTask.job -> PrintConfig.dll)을 만들고 있음을 알 수 있습니다. CreateHardLink(표준 API)를 사용하면 PrintConfig.dll에 하드링크를 걸 수 없기 때문이죠!
>James Forshaw가 만든 CreateNativeHardlink를 그대로 재사용하고 있음을 알 수 있습니다. CreateHardLink(표준API)를 사용하면 PrintConfig.dll에 하드링크를 걸 수 없기 때문이죠! 
